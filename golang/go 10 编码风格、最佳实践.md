## Table of Contents
  ...
  - [命名风格](#%E5%91%BD%E5%90%8D%E9%A3%8E%E6%A0%BC)
    ...
    - [用 var 还是 :=](#%E7%94%A8-var-%E8%BF%98%E6%98%AF-)
    - [作用域小变量名短](#%E4%BD%9C%E7%94%A8%E5%9F%9F%E5%B0%8F%E5%8F%98%E9%87%8F%E5%90%8D%E7%9F%AD)
    - [未导出的包变量加 _ 前缀](#%E6%9C%AA%E5%AF%BC%E5%87%BA%E7%9A%84%E5%8C%85%E5%8F%98%E9%87%8F%E5%8A%A0--%E5%89%8D%E7%BC%80)
  ...
  - [并发相关](#%E5%B9%B6%E5%8F%91%E7%9B%B8%E5%85%B3)
    ...
    - [请让 goroutine 都有善终](#%E8%AF%B7%E8%AE%A9-goroutine-%E9%83%BD%E6%9C%89%E5%96%84%E7%BB%88)
...
2. If your app has long running workers with message processing loops you'll also need a way to signal those goroutines that it's time to exit. You can send a "kill" message to each worker. 
3. Another option is to close a channel all workers are receiving from. It's a simple way to signal all goroutines at once.
...
func doWork(workerID int, wq <-chan interface{}, done <-chan struct{}, wg *sync.WaitGroup) {
   ...
   defer wg.Done() // wg 是指针类型避免拷贝、调用 wg.Done() 避免死锁
   for {
      select {
      case task := <-wq:
...
➤ [可以封装 Worker](https://github.com/uber-go/guide/blob/master/style.md#no-goroutines-in-init)
